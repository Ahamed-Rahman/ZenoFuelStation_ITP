    ...
    return (
        <div className="layout">
            ...
            <div className="management-header">
                <ul>
                    <li><Link to="/manager-welcome" className={location.pathname === '/manager-welcome' ? 'active' : ''}>Home</Link></li>
          ...
          <li><Link to="/manager-welcome/attendanceM" className={location.pathname.includes('User-management') ? 'active' : ''}>Attendance Management</Link></li>
                    ...
                    <li><Link to="/manager-welcome/leave" className={location.pathname === '/leave-request' ? 'active' : ''}>Leave Requesting</Link></li>
                    <li><Link to="salary-management" className={location.pathname.includes('salary-management') ? 'active' : ''}>Salary Management</Link></li>
                    <li><Link to="/manager-welcome/ManOrder" className={location.pathname.includes('order-management') ? 'active' : ''}>Order Management</Link></li>
